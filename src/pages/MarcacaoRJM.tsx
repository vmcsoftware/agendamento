...
export default function MarcacaoRJM() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Marcação de RJM</h1>
        <p className="text-muted-foreground mt-1">Cadastre RJM informando congregação, data e horário.</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="pt-2">
              <Button type="submit" disabled={!form.formState.isValid}>Agendar RJM</Button>
            </div>
          </form>
        </CardContent>
      </Card>
